                ...
                <div className="flex gap-2">
                    ...
                    {isStaff && (
                      <>
                        ...
                        <button onClick={() => {}} className="p-2 bg-red-500/10 text-red-500 rounded-xl hover:bg-red-500 hover:text-white transition-colors"><Trash2 size={16} /></button>
                      </>
                    )}
                </div>
              </div>
...
/* Mantém o AssessmentForm inalterado para brevidade */
const AssessmentForm = ({ assessment, studentId, students, onSave, onCancel }: any) => { return null; };
